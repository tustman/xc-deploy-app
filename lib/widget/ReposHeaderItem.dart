...
import 'package:xc_deploy_app/widget/GSYCardItem.dart';
import 'package:xc_deploy_app/widget/GSYIConText.dart';
import 'package:xc_deploy_app/widget/GSYSelectItemWidget.dart';
                  ...
                  children: <Widget>[
                    new Row(
                      children: <Widget>[
                        ...
                        new RawMaterialButton(
                          ...
                          onPressed: () {
                            NavigatorUtils.goPerson(
                                context, reposHeaderViewModel.ownerName);
                          },
                          child: new Text(reposHeaderViewModel.ownerName,
                        ...
                        ///仓库名
                        new Text(" " + reposHeaderViewModel.repositoryName,
                            style: GSYConstant.normalTextMitWhiteBold),
                      ],
                    ),
                    new Row(
                      children: <Widget>[
                        ...
                        ///仓库协议
                        new Text(reposHeaderViewModel.license ?? "--",
                            style: GSYConstant.smallSubLightText),
                      ],
                    ),
                        ...
                        child: new Row(
                          ...
                          children: <Widget>[
                            ...
                            _getBottomItem(
                              ...
                              () {
                                if (reposHeaderViewModel.allIssueCount ==
                                        null ||
