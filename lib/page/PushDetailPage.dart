...
import 'package:xc_deploy_app/widget/PushCoedItem.dart';
import 'package:xc_deploy_app/widget/PushHeader.dart';
import 'package:xc_deploy_app/common/utils/HtmlUtils.dart';
...
class _PushDetailPageState extends GSYListState<PushDetailPage> {
  ...
  _renderEventItem(index) {
    ...
    PushCodeItemViewModel itemViewModel = PushCodeItemViewModel
        .fromMap(pullLoadWidgetControl.dataList[index - 1]);
